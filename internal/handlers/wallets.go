...
// 		}
// 		_, err = accounts.CreateTransaction(r.Context(), qtx, nc, accounts.TrInput{
// 			DebitAccId:  debitId,
...
// 			}
// 			if accounts.PermReadBal&accounts.Permission(usr.Permissions) == accounts.PermReadBal {
...
// 			WalletID:    wData.Id,
// 			UserID:      userId,
// 			Permissions: int64(accounts.PermReadBal),
// 			UpdatedAt:   time.Now(),
// 			CreatedAt:   time.Now(),
// 		})
...
// 		}
// 		if accounts.PermReadBal&accounts.Permission(usrPerms) == accounts.PermReadBal {
...
// 			// send hex
// 			_, err = accounts.CreateTransaction(r.Context(), qtx, nc, accounts.TrInput{
// 				DebitAccId:  stelo.WalletID,
// 				CreditAccId: wData.Id,
// 				Code:        accounts.TxUserToUser,
// 				Memo:        &memo,
// 				Assets: []accounts.TxAssets{{
